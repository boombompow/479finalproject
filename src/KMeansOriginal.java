 ...
 * 
 */
public class KMeansOriginal implements Clusterer {
    /**
     ...
     */
    public KMeansOriginal(int clusters, int iterations) {
     ...
     */
    public KMeansOriginal(int clusters, int iterations, DistanceMeasure dm) {
...
//            }
        ...
        while (randomCentroids || (iterationCount < this.numberOfIterations && centroidsChanged)) {
            iterationCount++;
            System.out.println("iteration " + iterationCount + " " + randomCentroids + " " + centroidsChanged);
            ...
            for (int i = 0; i < this.numberOfClusters; i++) {
                if (countPosition[i] > 0) {
                	...
                	System.out.println(i + "" + dm.measure(newCentroid, centroids[i]));
                    if (dm.measure(newCentroid, centroids[i]) > 0.009) {
