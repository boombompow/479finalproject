...
<head>
	...
	<title>Centre for Engineering in Society - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fces%2Findex.php','Centre%20for%20Engineering%20in%20Society', '/');
					});
	}
...
<body id="body_li_ces_1" class="li_mainmenu_ces_1" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/ces/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
News &amp; events </a>
	...
	<h2 class="hide">CES</h2>
<div class="submenu">
<ul id="ul_gsu"> <li id="li_submenu_news-and-events_2" >
<a class="li_submenu_news-and-events_2_a" href="news-and-events/index.html">
News &amp; events </a>
</li>
<li id="li_submenu_mission_2" >
<a class="li_submenu_mission_2_a" href="mission/index.html">
Mission </a>
</li>
<li id="li_submenu_courses_2" >
<a class="li_submenu_courses_2_a" href="http://www.encs.concordia.ca/ces/courses/">
Courses </a>
</li>
<li id="li_submenu_research_2" >
<a class="li_submenu_research_2_a" href="research/index.html">
Research </a>
</li>
<li id="li_submenu_special-individualized-program_2" >
<a class="li_submenu_special-individualized-program_2_a" href="special-individualized-program/index.html">
Special individualized<br />program </a>
</li>
<li id="li_submenu_engineering-writing-test_2" >
<a class="li_submenu_engineering-writing-test_2_a" href="engineering-writing-test/index.html">
Engineering writing<br />test </a>
</li></ul>
</div>
	...
	<h1>Centre for Engineering in Society</h1>
...
<!-- InstanceBeginEditable name="MainContent" -->The Centre for Engineering  in Society is the site of complementary engineering education in the Faculty of  Engineering and Computer Science. Our goal is to assist students as they  develop communication skills, ethical reasoning and an understanding of the  relationship between technology and society on a global scale. Read our mission  and vision statement <a href="mission">here</a>. 

  <h2>Teaching</h2>
  <p>Our courses focus on core  skills identified by the Canadian Engineering Accreditation Board and in the  Concordia Strategic Plan, communication, analytical and synthetic thinking,  professionalism, and ethical practice. Through these courses, students gain an appreciation  of how their skills influence social  change. Our courses are listed <a href="courses">here</a>.</p>
  <h2>Research</h2>
  <p>Our faculty research takes an interdisciplinary  approach to the public, policy, social, and ethical factors that shape our  relationship to technology. Learn more about faculty research <a href="research">here</a>.</p>
  <p>Research opportunities in CES are available to  highly motivated and academically sound students. We welcome inquiries from  students interested in exploring technology-related questions in global  engineering, rhetoric, technical communication, risk, and the social impact of  engineering. More information about graduate and undergraduate research  opportunities is available <a href="special-individualized-program">here</a>. 
  <h2>Service</h2>
  <p>To help the Faculty  community stay abreast of the latest best practices in complementary  engineering education, we host the occasional lecture series, <em>Topics in Engineering Education.</em>  Find recent  lectures <a href="news-and-events">here</a>. </p>
  <p> We  also administer the <a href="engineering-writing-test/index.html">Engineering Writing Test</a>.</p>
...
<!-- InstanceBeginEditable name="Sidebar" --><div class="sidebar_box_1">
    <p>&nbsp;</p>
    <p><em>&ldquo;In the end, engineers are only really useful to  humanity if they can address concerns regarding risks to human health,  community wellbeing, and the integrity of the biosphere. Engineers can make  useful contributions here if their approach is one of cooperation and not of  absolute control.&rdquo;</em>
    <p>-<a href="http://scholar.google.ca/scholar?q=vandersteen+and+kelly&hl=en&btnG=Search&as_sdt=1%2C5&as_sdtp=on">VanderSteen &amp;  Kelly</a>, 2010 </p>
<h2>&nbsp;</h2></div>
        <div class="sidebar_box_1">
  <h2>People</h2>
  <ul>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Acemian__N._d_08">Ms. Nancy Acemian</a>, Senior Lecturer</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Dysart-Gale__D._d_08">Dr. Deborah Dysart-Gale</a>, Associate  Professor  &amp; Chair</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Grimes_2C_20K._d_08">Mr. Ken Grimes</a>, Lecturer</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Goldsmith__B._d_08">Dr. Bernice Goldsmith</a>, Adjunct Professor</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Gopakumar__G._d_08">Dr. Govind Gopakumar</a>, Assistant Professor &amp; Associate Chair</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Mudry__J._d_08">Dr. Jessica Mudry</a>, Associate Professor</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Schmitt__K._d_08">Dr. Ketra Schmitt</a>, Assistant Professor</li>
    <li><a href="../resources/faculty-and-staff-directory/details/_id_Williams__C._d_08">Ms. Carol Williams</a>, Assistant to the Chair</li>
  </ul>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/ces/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Centre for Engineering in Society - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/ces/index.php ...</p>
