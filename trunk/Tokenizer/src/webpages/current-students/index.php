...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fcurrent-students%2Findex.php','Current%20students', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/current-students/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<a class="li_submenu_registration_2_a" href="registration/">
Registration </a>
</li>
...
<!-- InstanceBeginEditable name="Sidebar" -->
  ...
  <h2>Online Tools</h2>
            ...
            <ul>
              ...
              <li><a href="../resources/schedules">ENCS Class &amp; Lab Schedules</a></li>
...
<!-- InstanceBeginEditable name="MainContent" -->
  ...
  <h2>Registration</h2>
  <p>Wondering how to add or drop a course or what the appropriate credit load for your course is? Check out our <a href="registration/">Registration pages</a>.</p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/current-students/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Current students - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/current-students/index.php ...</p>
